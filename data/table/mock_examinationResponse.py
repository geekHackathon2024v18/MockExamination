...
class MockExaminationResponse(Base):
    ...
    mock_examination: Mapped["MockExamination"] = relationship(back_populates="mock_examination_responses")
    question_responses: Mapped[List["QuestionResponse"]] = relationship(back_populates="question_responses", cascade="all, delete-orphan")
