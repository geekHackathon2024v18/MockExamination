...
class MockExaminationResponse(Base):
    ...
    def __repr__(self) -> str:
        return f"MockExaminationResponse(mock_examination_id={self.mock_examination_id!r}, interruption={self.interruption!r}, mock_examination_response_id={self.id!r}, created_at={self.created_at!r}, updated_at={self.updated_at!r})"
